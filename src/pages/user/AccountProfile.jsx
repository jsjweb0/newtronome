...
export default function AccountProfile() {
  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      const initUrl = data.photoURL ? data.photoURL : data.nickname ? nicknameUrl : avatarUrl;
      ...
      <div className="lg:w-md p-4 sm:p-7 m-auto lg:border lg:border-textThr rounded-xl">
        ...
        <div className="flex justify-center items-center">
          <div className="relative inline-block w-28 h-28">
            ...
            />
            {profileChanged && (
              <span className="animate-fade-in absolute top-1 end-2 block size-4 rounded-full bg-red-500 dark:ring-neutral-900"></span>
            )}
          </div>
        </div>
