    ...
    <div className="max-w-[85rem] mx-auto px-4">
      <div className="px-4 py-4 border-y border-gray-300 text-center">
        ...
        <div className="flex flex-wrap justify-center gap-2 text-xs md:text-sm text-white mt-4">
          <span className="inline-flex items-center gap-1.5 py-2 px-3 rounded-full bg-gray-100 text-gray-800 dark:bg-neutral-800 dark:text-neutral-200">
            {post.kindNm}
          </span>
          <span className="inline-flex items-center gap-1.5 py-2 px-3 rounded-full bg-gray-100 text-gray-800 dark:bg-neutral-800 dark:text-neutral-200">
      ...
      <div className="py-5 px-3 md:py-12 md:px-7 border-b border-gray-300">
        <div className="bg-white border border-gray-200 rounded-lg shadow-lg mb-8 p-5 dark:bg-neutral-800 dark:border-neutral-700">
          <div className="flex">
            ...
            <div className="ms-2.5">
              <p className="text-xs md:text-sm text-gray-700 dark:text-neutral-400">
                ...
                에서 제공하는 국가동물보호정보시스템 구조동물 조회 서비스로 직접 수정/삭제할 수
                없습니다.
              </p>
            </div>
          </div>
        ...
        <div>
          ...
          <div className="flex flex-col mt-8 md:mt-12">
            ...
            <div className="p-1.5 -m-1.5 overflow-x-auto">
              <div className="min-w-full inline-block align-middle border border-gray-200 rounded-lg shadow-xs overflow-hidden dark:border-neutral-700 dark:shadow-gray-900">
                <table className="w-full divide-y divide-gray-200 text-left dark:divide-neutral-700">
                  <tbody className="divide-y divide-gray-200 dark:divide-neutral-700">
                    <tr>
                      <th className="w-20 md:w-40 px-3 md:px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-500 dark:text-neutral-400">
                        공고번호
                      </th>
                    ...
                    <tr>
                      ...
                      <td className="px-3 md:px-6 py-4 text-sm text-gray-800 dark:text-neutral-200">
                        ...
                        <span className="inline-flex items-center gap-x-1.5 ml-2 py-1 px-2 rounded-full text-xs font-medium bg-blue-600 text-white dark:bg-blue-500">
                          {dayLeft > 0 ? dayLeft : dayLeft === 0 ? '오늘 마감' : '마감됨'}일
                        </span>
                      </td>
                    </tr>
                    <tr>
                      <td className="w-20 md:w-40 px-3 md:px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-500 dark:text-neutral-400">
                        동물등록번호
                      </td>
                      <td className="px-3 md:px-6 py-4 text-sm text-gray-800 dark:text-neutral-200">
                        {post.rfidCd}
          ...
          <div className="flex flex-col mt-12">
            ...
            <p className="flex items-center gap-1 text-sm italic text-gray-400 mt-3">
              <Info className="shrink-0 size-4" />
                  ...
                  <tbody className="divide-y divide-gray-200 dark:divide-neutral-700">
                    ...
                    <tr>
                      ...
                      <td className="px-3 md:px-6 py-4 break-keep text-sm text-gray-800 dark:text-neutral-200">
                        ...
                        >
                          구글맵 바로가기
                          <SquareArrowOutUpRight className="shrink-0 size-4 mt-1 group-hover:text-blue-800 dark:group-hover:text-blue-400" />
                        </a>
                      </td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <td className="px-3 md:px-6 py-4 text-sm font-medium">
                        ...
                        >
                          <PhoneOutgoing className="shrink-0 size-4 mt-1 group-hover:text-blue-800 dark:group-hover:text-blue-400" />
                          {post.careTel}
                        </a>
                      </td>
                    </tr>
