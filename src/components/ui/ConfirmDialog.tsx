...
export default function ConfirmDialog({
  ...
  return (
    <Dialog role="alertdialog" open={isOpen} onClose={onDismiss} className="relative z-999">
            ...
            <div className="relative flex flex-col bg-background rounded-xl">
              <div className="absolute top-2 bottom-2">
                <button
                  ...
                  aria-label="닫기"
                >
                  <CloseIcon aria-hidden="true" className="size-4 md:size-5" />
                </button>
              </div>

              <div className="p-8 md:p-14 text-center overflow-y-auto">
                <DialogTitle className="mb-2 font-bold text-gray-800 dark:text-neutral-200 text-base md:text-xl">
                  {title}
                </DialogTitle>
