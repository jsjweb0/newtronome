      ...
      <form>
        <div className="flex flex-row items-center gap-2 relative">
          ...
          <div className="shrink-0 absolute top-0 right-[3rem] z-20 h-full">
            <Menu>
              <MenuButton className="flex items-center gap-x-1.5 w-full h-full py-2.5 px-4 rounded-lg text-xs md:text-sm text-gray-600 dark:hover:bg-neutral-800 dark:focus:bg-neutral-800 disabled:opacity-50 disabled:pointer-events-none focus:outline-hidden dark:text-neutral-400">
                <SlidersHorizontal className="size-4" />
                검색조건
                <span className="inline-block py-0.5 px-1.5 rounded-full bg-gray-800 text-center text-xs text-white dark:bg-neutral-500">
                  {appliedFilterCount}
                </span>
              </MenuButton>
              <MenuItems
                ...
                anchor="bottom end"
                className={clsx(
                  'transition-[opacity,translate] duration-200 opacity-100 data-closed:opacity-0 translate-y-2 data-closed:translate-0',
                  'w-[33rem] bg-white shadow-md rounded-lg',
          ...
          <div className="group relative inline-flex items-center gap-x-3">
            <label htmlFor="likeList" className="relative inline-block w-11 h-6 cursor-pointer">
              ...
              <span className="absolute top-1/2 inset-s-0.5 -translate-y-1/2 size-5 bg-white rounded-full shadow-xs transition-transform duration-200 ease-in-out peer-checked:translate-x-full dark:bg-neutral-400 dark:peer-checked:bg-white"></span>
            </label>
            <div
